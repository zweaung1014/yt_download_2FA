...
test('test', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Enter code' }).fill('604846');
  ...
  await page.waitForSelector('#checkbox-container', { timeout: 10000 });
  const rows = await page.locator('#checkbox-container').elementHandles();
